...
export function GeneralExercises({ navigation }: { navigation: any }) {
  return (
    <View style={styles.generalExerciseContainer}>
      ...
      <ScrollView>
        <ShowExercisesGeneral
          exercises={total_exercises_dict}
...
function ShowExercisesGeneral({ exercises, navigation }) {
  return (
    <View style={styles.showGeneralExerciseContainer}>
      {exercises.map((exercise: any) => (
        ...
        >
          <Image source={exercise.img} style={styles.generalExerciseImage} />
          <Text style={styles.generalExerciseText}>{exercise.name}</Text>
        </TouchableOpacity>
      ))}
    </View>
  );
